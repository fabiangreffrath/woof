...
setup_menu_t weap_settings1[] =  // Weapons Settings screen       
{
  ...
  {"Weapon Swinging",S_CHOICE,m_null,WP_X, WP_Y+weap_swing*8, {"weapon_swing"}, 0, 0, NULL, weapon_swing_strings},
...
setup_menu_t comp_settings2[] =  // Compatibility Settings screen #2
{
  ...
  {"Fix 3-key door works with only 2 keys", S_YESNO, m_null, C_X,
   ...
   // notarget137 A_CheckReload fix
  {"Fix SSG switching reloading with no ammo", S_YESNO, m_null, C_X,
