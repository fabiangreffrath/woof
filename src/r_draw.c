...
{
    columnofs = Z_Malloc(video.width * sizeof(*columnofs), PU_VALLOC, NULL);
    ylookup = Z_Malloc(video.height * sizeof(*ylookup), PU_VALLOC, NULL);
    solidcol = Z_Calloc(1, video.width * sizeof(*solidcol), PU_VALLOC, NULL);
}
