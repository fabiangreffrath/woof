  ...
  switch(line->special)
    ...
    case 133:
      if (!p->cards[it_bluecard] && !p->cards[it_blueskull])
        {
          doomprintf(p, MESSAGES_NONE, DEH_String(PD_BLUEO));  // Ty 03/27/98 - externalized
    ...
    case 135:
      if (!p->cards[it_redcard] && !p->cards[it_redskull])
        {
          doomprintf(p, MESSAGES_NONE, DEH_String(PD_REDO)); // Ty 03/27/98 - externalized
          S_StartSound(p->mo,sfx_oof);                // killough 3/20/98
          return 0;
        }
      break;
    ...
    case 137:
      if (!p->cards[it_yellowcard] && !p->cards[it_yellowskull])
        {
          doomprintf(p, MESSAGES_NONE, DEH_String(PD_YELLOWO));  // Ty 03/27/98 - externalized
          S_StartSound(p->mo,sfx_oof);                    // killough 3/20/98
          return 0;
        }
      break;
  ...
  switch(line->special)
    ...
    case 32:
      ...
      if (!player->cards[it_bluecard] && !player->cards[it_blueskull])
        {
          doomprintf(player, MESSAGES_NONE, DEH_String(PD_BLUEK));  // Ty 03/27/98 - externalized
    ...
    case 34:
      ...
      if (!player->cards[it_yellowcard] && !player->cards[it_yellowskull])
        {
          doomprintf(player, MESSAGES_NONE, DEH_String(PD_YELLOWK));  // Ty 03/27/98 - externalized
          S_StartSound(player->mo,sfx_oof);               // killough 3/20/98
          return 0;
        }
      break;
    ...
    case 33:
      ...
      if (!player->cards[it_redcard] && !player->cards[it_redskull])
        {
          doomprintf(player, MESSAGES_NONE, DEH_String(PD_REDK)); // Ty 03/27/98 - externalized
          S_StartSound(player->mo,sfx_oof);           // killough 3/20/98
          return 0;
        }
      break;
