...
int G_CalcGamepadSideTurn(int speed)
{
    ...
    return clampi(side, -forwardmove[speed], forwardmove[speed]);
}
...
int G_CalcGamepadSideStrafe(int speed)
{
    ...
    return clampi(side, -sidemove[speed], sidemove[speed]);
}
...
int G_CalcGamepadForward(int speed)
{
    ...
    return clampi(forward, -forwardmove[speed], forwardmove[speed]);
}
