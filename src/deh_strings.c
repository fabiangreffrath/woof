...
static const char *FormatStringReplacement(const char *s)
{
    ...
    {
        I_Printf(VB_WARNING, "WARNING: Unsafe dehacked replacement provided for printf format string: %s", s);
        return s;
    }
...
void PRINTF_ATTR(3, 4) DEH_snprintf(char *buffer, size_t len, const char *fmt, ...)
{
